                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <div class="float-right mb-3">
                                            <a href="<?= $hostToResources ?>dokter/tambah-resep"><button class="btn btn-primary text-white" title="Tambah Resep"><i class="fa fa-plus"></i></button></a>
                                        </div>
                                                ...
                                                <?php else : ?>
                                                    <?php foreach ($queryResep as $row) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= $hostToResources ?>dokter/edit-data-resep?idResep=<?= $row->idResep ?>" class="text-white"><button class="btn btn-info button-indent" id="btnEditDokter"><i class="fa fa-edit"></i> Ubah</button></a>
                                                                <a href="<?= $hostToResources ?>dokter/functions/hapus-resep?idResep=<?= $row->idResep ?>" id="hapusResep"><button class="btn btn-danger button-indent" id="btnHapusResep" data-nama="<?= $row->namaObat ?>"><i class="fa fa-trash text-white"></i></a> Hapus</button>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                <?php endif ?>
