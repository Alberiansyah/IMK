                                                ...
                                                <?php else : ?>
                                                    <?php foreach ($queryObat as $row) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $row->hargaObat ?></td>
                                                            <td>
                                                                <a href="<?= $hostToResources ?>dokter/edit-data-obat?idObat=<?= $row->idObat ?>" class="text-white"><button class="btn btn-info button-indent" id="btnEditDokter"><i class="fa fa-edit"></i> Ubah</button></a>
                                                                <a href="<?= $hostToResources ?>dokter/functions/hapus-obat?idObat=<?= $row->idObat ?>" id="hapusObat"><button class="btn btn-danger button-indent" id="btnHapusObat" data-nama="<?= $row->namaObat ?>"><i class="fa fa-trash text-white"></i></a> Hapus</button>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
