...
$queryAdmin = tampilData("SELECT * FROM tb_users INNER JOIN tb_level WHERE tb_level.idLevel = tb_users.idLevel AND tb_level.idLevel = 1 AND tb_users.idUser != $userSesi->idUser");
$i = 1;
    ...
    <div class="page-inner no-page-title">
        <div id="main-wrapper">
            <div class="content-header">
                ...
                <h1 class="page-title ml-3">Data Admin</h1>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="float-right">
                                    <button class="btn btn-primary text-white" title="Tambah Admin"><i class="fa fa-plus"></i></button>
                                </div>
