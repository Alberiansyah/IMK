...
$queryPasien = cariPasien("SELECT * FROM tb_users INNER JOIN tb_level WHERE tb_level.idLevel = tb_users.idLevel 
                                                                AND tb_level.namaLevel = 'PASIEN' 
                                                                AND email LIKE ?
                        ");

$rows = count($queryPasien);
$no = 1;
